...
\caption{Hyperparameter grid searches conducted for each model class. Each numbered search represents a separate grid search. The hyperparameter search space for each grid search is detailed in the third column.}
